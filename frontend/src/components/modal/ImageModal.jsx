        ...
        <>
            {selectedImageIndex !== null && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="relative bg-zinc-100 bg-opacity-40 w-[600px] rounded-3xl ">
                        <div className="flex justify-around px-4 items-center py-2 mt-2">
                            <p className="font-extralight text-2xl text-zinc-200">
                                Visor de imagenes
                            </p>
                        ...
                        <div className="flex items-center justify-center p-4 w-[600px] h-[600px] relative">
                            { images.length  > 1 && (
                                <button onClick={handlePrevImage} className="h-3/4 absolute left-4 z-10 px-2 text-white rounded-full hover:bg-opacity-75">
                                    <svg className="w-5 h-5 rounded-full bg-zinc-200 text-white sm:w-9 sm:h-9 dark:text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
